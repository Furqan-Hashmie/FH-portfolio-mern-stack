...
const Footer = () => {
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <p class="text-[17px] text-white font-bold sm:ml-4 sm:pl-4  sm:py-2 sm:mt-0 mt-4"> © 2024 All rights reservered-Furqan Hashmi
    </p>
    <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 space-x-5 justify-center sm:justify-start">
     <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
        <img src="https://img.icons8.com/fluent/30/000000/facebook-new.png" className="h-8 w-8" alt='img' />
      </a>
      <a href="https://www.linkedin.com/in/furqan-hashmi/" target="_blank" rel="noopener noreferrer">
        <img src="https://img.icons8.com/fluent/30/000000/linkedin-2.png" className="h-8 w-8" alt='img'/>
      </a>
      <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" >
        <img src="https://img.icons8.com/fluent/30/000000/instagram-new.png" className="h-9 w-9" alt='img'/>
      </a>
