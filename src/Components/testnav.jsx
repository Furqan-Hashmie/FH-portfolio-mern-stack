   ...
   <div className="mt-24">
    ...
    <card className="sm:mx-4 md:mx-8 lg:mx-16 flex-row sm:flex-col md:flex-col lg:flex-row xl:flex-row bg-gray-300 border-2  p-3 shadow-md shadow-teal-700">
        ...
        >
          <div className="rounded-xl">
            <Splide options={{ rewind: true, gap: '1rem', heightRatio: .53 }} aria-label="React Splide Example">
              <SplideSlide>
                <img src="/images/j.topimg.PNG" className="h-full rounded-xl" alt="img" />
              </SplideSlide>
              <SplideSlide>
                <img src="/images/footer j..PNG" className="rounded-xl h-full" alt="img"/>
              </SplideSlide>
              <SplideSlide>
                <img src="/images/new arival.PNG" className="rounded-xl" alt="img"/>
              </SplideSlide>
            </Splide>
          </div>
        ...
        <cardbody className="text-black mt-2 sm:text-center md:text-center lg:text-start xl:text-start">
          <nav variant="h6" color="gray" className="mb-4 uppercase text-black font-bold text-2xl ">
            Ecommerce Website
          </nav>
          <nav variant="h4" color="blue-gray" className="mb-2 text-black text-xl">
