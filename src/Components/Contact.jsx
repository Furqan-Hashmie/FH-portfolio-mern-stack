...
const Contact = () => {
  ...
  <h1 className="text-6xl sm:text-5xl font-bold text-center mt-10">Get in<span className="text-yellow-500 ml-4">Touch</span></h1>
      ...
      <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex">
        <img src="https://img.icons8.com/fluent/30/000000/facebook-new.png" className="h-10 w-10 me-2" />
      ...
      <a href="https://www.linkedin.com/in/furqan-hashmi/" target="_blank" rel="noopener noreferrer" className="flex">
        <img src="https://img.icons8.com/fluent/30/000000/linkedin-2.png" className="h-10 w-10 me-2"/>
        <p className="text-white mt-1.5 text-2xl">LinkedIn</p>
      </a>
     <a href="https://wa.me/923134122910" target="_blank" className="flex" >
     ...
     <a href="https://github.com/Furqan-Hashmie" target="_blank" className="flex ">
